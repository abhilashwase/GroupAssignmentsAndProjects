...
public class Lab7 {
    ...
    private void generatePost(String[] row, Comment comment){
        ...
        if(posts.containsKey(userId)){
            List<Comment> comments = posts.get(userId).getComments();
    ...
    private void runAnalysis(){
        ...
        helper.inactiveUsersBasedOnTotalPostsNumber();
        helper.inactiveUsersBasedOnTotalComments();
        helper.inactiveAndProcativeUsersOverall();
